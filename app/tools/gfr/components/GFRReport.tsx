...
export const GFRReport = () => {
  ...
  let cockcroft = t("textCockcroftRequired")
  ...
  if (age === null) {
    return (
      <>
        <Paragraph>
          <Statement>{t("textAgeMissing")}</Statement>
        </Paragraph>
      </>
    )
  }
