...
import { I18nStructuredReportContextProvider } from "app/core/contexts/I18nStructuredReportContext"
import { useOnRouteChange } from "app/core/hooks/useOnRouteChange"
import { useSiteLanguageListener } from "app/core/hooks/useSiteLanguageListener"
import { useSiteTranslation } from "app/core/hooks/useSiteTranslation"
import { I18nStructuredReportProps, StructuredReportLanguageOption } from "app/core/types"
import { createClient } from "app/core/utils/i18nBrowserClient"
import { registerInstance } from "app/core/utils/i18nextReloader"

interface StructuredReportTranslationProviderProps {
  i18nStructuredReportProps: I18nStructuredReportProps["_i18nStructuredReport"]
  children: ReactNode
}
