...
export const AdrenalWashoutStructure = () => (
  <>
    ...
    <Alert>
      The ROI should cover approximately two-third of the lesion without including the periphery to
      reduce partial volume averaging effects of the surrounding fat.
    </Alert>
    <Alert>Whenever possible the absolute washout should be preferred.</Alert>
  </>
)
